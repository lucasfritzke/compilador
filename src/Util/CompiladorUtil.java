...
import pLexico.LexicalError;
import pLexico.Lexico;
import pLexico.Token;
...
public class CompiladorUtil {
    ...
    public void metodoCompilar() {
    	JTextArea m = (JTextArea) getComponentByName("CodeBlock");
    	JTextArea m1 = (JTextArea) getComponentByName("MessageBlock");
    	//m.setText("Compilação de programas ainda não foi implementada!");
    	Lexico lexico = new Lexico();
    	   lexico.setInput(m.getText());
    	   try {
    	   Token t = null;
    	   String msg ="";
